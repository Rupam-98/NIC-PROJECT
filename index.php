...
<head>
  ...
  <style>
    ...
    .container:hover {
      ...
      box-shadow: 0 16px 36px rgba(79,140,255,0.10);
    }
...
<body>
  <div class="container">
    ...
    <footer>&copy; 2025 National Information Center</footer>
  </div>

  <!-- <script>
    
    const links = document.querySelectorAll('.login-btn');
    links.forEach(link => {
      link.addEventListener('click', e => {
        
         if (!confirm('Do you want to continue to the login page?')) {
          e.preventDefault();
        }
      });
    });
